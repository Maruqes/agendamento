...
const INSERT_QUERY = "INSERT INTO marcacoes (email, user_number, service, duration, ano, mes, dia, hora, minuto) VALUES(?,?,?,?,?,?,?,?,?)";
const SELECT_ALL_QUERY = "SELECT ano,mes,dia,hora,minuto,duration FROM marcacoes";
...
function add_db(service, email, user_number, ano, mes, dia, hora, minuto, duration) {
    return new Promise((resolve, reject) => {
        db.run(INSERT_QUERY, [email, user_number, service, duration, ano, mes, dia, hora, minuto], (err) => {
            if (err) {
                reject(err);
            }
            resolve();
